⚙️ Cómo lo hacemos (versión técnica para desarrolladores)

Nota: Esta documentación describe los principios técnicos generales.
...
📌 2. Certificación del documento

Pseudo-código neutral (no patentable):
...
Luego se registra en Hoja de Auditoría:
...
📌 6. Formato .ECO (contenedor seguro)
...
Ejemplo real (extraído del repo):
