...
type IntegrationService = 'mifiel' | 'signnow' | string;
...
interface IntegrationModalProps {
  ...
  onConfirm: (data: IntegrationData & { paymentMethod: string; status: string }) => Promise<void> | void;
}

const IntegrationModal: React.FC<IntegrationModalProps> = ({ isOpen, onClose, integrationData, onConfirm }) => {
