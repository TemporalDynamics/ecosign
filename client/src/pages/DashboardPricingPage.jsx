    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-cyan-50">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-10">
        <div className="text-center">
          <p className="text-xs font-semibold tracking-[0.3em] text-black mb-3">PLANES INTERNOS</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div key={plan.name} className={`relative bg-white rounded-2xl shadow-lg border ${plan.popular ? 'border-black500' : 'border-gray-200'}`}>
              {plan.popular && (
              ...
              <div className="p-8">
                ...
                <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-black to-gray-800 mb-3">{plan.price}</p>
                ...
                <button className={`w-full py-3 rounded-lg font-semibold ${plan.popular ? 'bg-gradient-to-r from-black to-gray-800 text-white' : 'bg-gray-100 text-cyan-700'}`}>
                  {plan.button}
                </button>
              </div>
            </div>
