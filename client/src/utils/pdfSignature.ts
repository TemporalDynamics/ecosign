...
export interface ForensicData {
  ...
  legalTimestamp?: boolean;
  polygonAnchor?: boolean;
 ...
 */
export async function addSignatureSheet(
  pdfFile: File,
  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      throw new Error("An unknown error occurred while adding signature sheet.");
    }
  }
}
