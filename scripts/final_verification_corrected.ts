...
async function runFinalVerification() {
  ...
  try {
    ...
    console.log('⚠️ Error verificando función SQL (puede ser normal si flag no existe):', error.message);
    // No es crítico si el flag no existe, solo verificar que la función existe
  }
  ...
  // 6. Verificar que hay cron jobs para orchestrator
