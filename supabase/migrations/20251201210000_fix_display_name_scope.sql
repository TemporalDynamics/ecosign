...
DECLARE
  ...
  display_name TEXT; -- MOVIDO AQUÍ: debe estar en el DECLARE principal
BEGIN
...
COMMENT ON FUNCTION notify_signer_link IS 'Trigger function corregido - display_name en scope correcto';
