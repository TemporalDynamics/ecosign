-- Actualizar notify_signer_link para nuevos estados canónicos
...
DECLARE
  ...
  display_name TEXT;
BEGIN
  IF NEW.status IN ('invited', 'ready_to_sign') AND TG_OP = 'INSERT' THEN
...
COMMENT ON FUNCTION notify_signer_link IS 'Trigger function para notificar firmantes con estados canónicos';
