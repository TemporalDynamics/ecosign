-- ============================================
-- Migration: Update Wake Execution Engine Function
-- Fecha: 2026-01-27
-- Descripción: Actualiza la función wake_execution_engine para despertar el sistema
-- ============================================
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '✅ Función wake_execution_engine actualizada';
