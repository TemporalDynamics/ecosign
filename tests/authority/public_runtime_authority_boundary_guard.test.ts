...
const ALLOWLIST = new Map<string, string>([
  ['accept-nda', 'nda legacy compatibility'],
  ...
  ['create-invite', 'legacy document_id pointer (optional)'],
  ...
  ['notify-document-signed', 'documentId payload for signed email template'],
