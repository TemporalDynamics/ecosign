...
describe('EPI ECO invariants (regression)', () => {
  test('EPI-INV-001 / EPI-INV-002 / EPI-INV-004: witness and proofs consistency across signers', () => {
  ...
  test('EPI-INV-002: ECO with proof mismatch is invalid', () => {
